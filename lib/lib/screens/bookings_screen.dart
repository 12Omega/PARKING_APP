    ...
    return Column(
      children: [
        Padding(
          ...
          child: SizedBox(
            // Constrain the height of the chip row
            height: 40,
            child: ListView.separated(
              // Use ListView for horizontal scrolling if many chips
          ...
          child: currentBookings.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      elevation:
                          theme.cardTheme.elevation ?? 1.0, // Subtle elevation
                      margin:
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                if (isPending || isConfirmed)
                                  TextButton(
                                    child: Text(
                                      isConfirmed ? 'View Details' : 'Manage',
                                    ),
                                    onPressed: () {
                                      /* TODO: Action */
                                    },
