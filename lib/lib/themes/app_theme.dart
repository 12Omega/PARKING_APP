...
class AppTheme {
  ...
  static final Color _darkBlue =
      Colors.blue[700]!; // A darker blue for accents if needed
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(
        foregroundColor:
            _darkBlue, // Use a darker blue for text buttons for contrast
        textStyle: GoogleFonts.roboto(fontWeight: FontWeight.w500),
      ),
    ),
    useMaterial3: true,
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    primaryColor:
        _lightBlue, // Can use the same light blue, or a different shade
    colorScheme: ColorScheme.fromSeed(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor:
            _lightBlue, // Light blue can work on dark for primary actions
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(
        foregroundColor:
            _lightBlue, // Light blue for text buttons on dark background
        textStyle: GoogleFonts.roboto(fontWeight: FontWeight.w500),
      ),
    ),
    useMaterial3: true,
