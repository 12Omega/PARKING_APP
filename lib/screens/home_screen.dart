        ...
        ContentCard(
          ...
          child: Text(
            ...
            style: theme.textTheme.bodyMedium?.copyWith(
              color: theme.colorScheme.onSurfaceVariant, // Slightly less prominent than onSurface
            ),
          ),
        ),
        ...
        ContentCard(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row( // Using a Row for buttons to appear side-by-side if space allows, or wrap
                children: [
                  ElevatedButton.icon(
