...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _onTabTapped(int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        _navigatorKey.currentState?.pushReplacementNamed(DashboardRoutes.bookings);
        break;
      case 2:
        _navigatorKey.currentState?.pushReplacementNamed(DashboardRoutes.profile);
        break;
    }
  }
  ...
  Route<dynamic>? _onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case DashboardRoutes.bookings:
        return MaterialPageRoute(builder: (_) => const BookingsScreen(), settings: settings);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Parking App Dashboard"), centerTitle: true), // AppBar remains
      body: Navigator(
        key: _navigatorKey,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.local_parking), // Changed from Icons.list to Icons.local_parking
            label: "Bookings",
          ),
