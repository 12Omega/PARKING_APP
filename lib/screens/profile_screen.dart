...
class ProfileScreen extends StatelessWidget {
  ...
  Widget _buildProfileListTile({
    ...
    bool isDestructive = false, // For items like "Delete Account" if added later
  }) {
    final theme = Theme.of(context);
    Color iconColor = isDestructive ? theme.colorScheme.error : theme.colorScheme.primary;
    Color textColor = isDestructive ? theme.colorScheme.error : theme.colorScheme.onSurface;
    ...
    return ListTile(
      ...
      trailing: isDestructive ? null : Icon(Icons.chevron_right, color: theme.colorScheme.outline, size: 22),
      onTap: onTap,
        ...
        Center(
          child: ElevatedButton.icon(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: theme.colorScheme.error, // More prominent error color
